...
entity Application_p_hls_fptosi_float_i32 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Application_p_hls_fptosi_float_i32 is 
...
attribute shreg_extract : string;
    signal p_Result_s_reg_181 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal val_fu_162_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal val_reg_186 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal result_V_fu_175_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1))) then
                p_Result_s_reg_181 <= data_V_fu_44_p1(31 downto 31);
    ...
    ap_return_assign_proc : process(result_V_fu_175_p3, ap_ce_reg, ap_return_int_reg)
    begin
    ...
    result_V_2_fu_170_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(val_reg_186));
    result_V_fu_175_p3 <= 
        result_V_2_fu_170_p2 when (p_Result_s_reg_181(0) = '1') else 
        val_reg_186;
