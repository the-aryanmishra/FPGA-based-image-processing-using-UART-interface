...
HLS_SOURCES = ../../../../TestBench.cpp ../../../../Application.cpp
...
$(ObjDir)/Application.o: ../../../../Application.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Application.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Application.d
